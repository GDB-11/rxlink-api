...
public sealed record GetByUsernameAsyncError(string? Details = null, Exception? Exception = null)
    : UserError("An unexpected error occurred while retrieving the user by username.", Details, Exception);

public sealed record GetByCodeAsyncError(string? Details = null, Exception? Exception = null)
    : UserError("An unexpected error occurred while retrieving the user by code.", Details, Exception);

public sealed record GetByRefreshTokenAsyncError(string? Details = null, Exception? Exception = null)
    : UserError("An unexpected error occurred while retrieving the user by refresh token.", Details, Exception);
...
public sealed record ClearRefreshTokenAsyncError(string? Details = null, Exception? Exception = null)
    : UserError("An unexpected error occurred while revoking the refresh token.", Details, Exception);